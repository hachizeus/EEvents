...
<img src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-banner.png?v=1" alt="E.Events - オープンソースイベントチケット販売プラットフォーム" width="100%">
...
[クラウド版を試す →](https://app.E.Events/auth/register?utm_source=gh-readme) · [ライブデモ](https://app.E.Events/event/2/hievents-conference-2030?utm_source=gh-readme) · [ドキュメント](https://E.Events/docs?utm_source=gh-readme) · [ウェブサイト](https://E.Events?utm_source=gh-readme)
...
多くのチケット販売プラットフォームは、チケットごとの手数料を請求し、あなたのデータを自社のエコシステムに閉じ込めます。**E.Eventsは、Eventbrite、Tickettailor、Dice.fm、その他のチケット販売プラットフォームに代わる、モダンなオープンソースの代替品です。**ブランディング、チェックアウト、データ、インフラストラクチャを完全にコントロールしたい主催者向けです。

ナイトライフプロモーター、フェスティバル主催者、会場、コミュニティグループ、カンファレンス主催者向けに構築されています。

<br>

<img alt="E.Eventsダッシュボード" src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-screenshot.png"/>
...
| 機能                      | E.Events | Eventbrite | Tickettailor | Dice    |
|:--------------------------|:----------|:-----------|:-------------|:--------|
| セルフホスティングオプション | ✅         | ❌          | ❌            | ❌       |
| オープンソース             | ✅         | ❌          | ❌            | ❌       |
| チケット手数料なし（セルフホスティング） | ✅         | ❌          | ❌            | ❌       |
...
[![DigitalOceanでデプロイ](https://www.deploytodo.com/do-btn-blue.svg)](https://github.com/HiEventsDev/E.Events-digitalocean)
[![Renderでデプロイ](https://render.com/images/deploy-to-render-button.svg)](https://github.com/HiEventsDev/E.Events-render.com)
...
📖 [完全なインストールガイド](https://E.Events/docs/getting-started?utm_source=gh-readme)

<br>

## E.Events Cloud

セルフホスティングを希望しない場合は、**[E.Events Cloud](https://app.E.Events/auth/register?utm_source=gh-readme)**が完全に管理されたオプションで、セットアップなし、自動更新、管理されたインフラストラクチャを提供します。

[今すぐ始める →](https://app.E.Events/auth/register?utm_source=gh-readme)
...
| リソース       | リンク                                                                                          |
|:---------------|:-----------------------------------------------------------------------------------------------|
| はじめに       | [E.Events/docs/getting-started](https://E.Events/docs/getting-started?utm_source=gh-readme) |
| 設定           | [E.Events/docs/configuration](https://E.Events/docs/configuration?utm_source=gh-readme)     |
| APIリファレンス | [E.Events/docs/api](https://E.Events/docs/api?utm_source=gh-readme)                         |
...
📖 [ドキュメント](https://E.Events/docs?utm_source=gh-readme) · 📧 [hello@E.Events](mailto:hello@E.Events) ·
...
新機能と改善については、[リリースページ](https://github.com/HiEventsDev/E.Events/releases)で最新情報を入手してください。

<br>

## ライセンス

E.Eventsは**AGPL-3.0（追加条項付き）**でライセンスされています。商用ライセンスも利用可能です。[詳細はこちら](https://E.Events/licensing)。

<br>

<div align="center">

**[ウェブサイト](https://E.Events)** · **[ドキュメント](https://E.Events/docs)** · **[Twitter/X](https://x.com/HiEventsTickets)**
