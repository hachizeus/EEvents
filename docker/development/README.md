# E.Events local development with Docker

This guide walks you through setting up E.Events using Docker, including requirements, setup steps, configuration,
...
```bash
cd E.Events/docker/development
./start-dev.sh
```
...
E.Events uses environment variables for configuration. You’ll find `.env` files in:
...
For a full list of environment variables, see the [Environment Variables Documentation](https://E.Events/docs/getting-started/deploying#environment-variables).
