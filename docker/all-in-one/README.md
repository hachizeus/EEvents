# E.Events All-in-One Docker Image
...
the [Docker image](https://hub.docker.com/r/daveearley/E.Events-all-in-one), or create your own Docker compose file with the 
necessary [configurations for production](https://E.Events/docs/getting-started/deploying#configuring-environment-variables).
