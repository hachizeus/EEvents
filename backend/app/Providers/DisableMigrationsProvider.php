...
class NoOpMigrationRepository implements MigrationRepositoryInterface
{
    ...
    public function getMigrations($steps = 0) 
    { 
        return []; 
    }
    ...
    public function rollback($migrations, $pretend = false) 
    { 
        return true; 
    }
    ...
    {
        // No-op - we're not using any real source
        return $this;
    }
}
...
class DisableMigrationsProvider extends ServiceProvider
{
     ...
     * a no-op migration repository that implements all required methods.
     */
