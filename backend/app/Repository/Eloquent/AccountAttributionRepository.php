    ...
    public function getAttributionStats(
        ...
        $query = DB::table('account_attributions as aa')
            ->select([
                ...
                DB::raw('COUNT(DISTINCT CASE WHEN aps.is_active = true THEN aa.account_id END) as paystack_connected'),
            ...
            ->leftJoin('account_paystack_settings as aps', function ($join) {
                $join->on('a.id', '=', 'aps.account_id');
            })
