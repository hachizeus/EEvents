...
<img src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-banner.png?v=1" alt="E.Events - 開源活動售票平台" width="100%">
...
[試用雲端版 →](https://app.E.Events/auth/register?utm_source=gh-readme) · [線上示範](https://app.E.Events/event/2/hievents-conference-2030?utm_source=gh-readme) · [技術文檔](https://E.Events/docs?utm_source=gh-readme) · [官方網站](https://E.Events?utm_source=gh-readme)
...
大多數售票平台會收取每張門票的手續費，並將您的數據鎖定在其生態系統中。**E.Events 是 Eventbrite、Tickettailor、Dice.fm 及其他售票平台的現代化開源替代方案**，專為希望完全掌控品牌、結帳流程、數據及基礎設施的主辦方而設。

專為夜生活推廣者、節慶主辦方、場地、社區團體及會議主持人而建。

<br>

<img alt="E.Events 管理面板" src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-screenshot.png"/>
...
| 功能                    | E.Events | Eventbrite | Tickettailor | Dice    |
|:----------------------|:----------|:-----------|:-------------|:--------|
| 自行託管選項                | ✅         | ❌          | ❌            | ❌       |
| 開源                    | ✅         | ❌          | ❌            | ❌       |
| 無每張門票手續費（自行託管）       | ✅         | ❌          | ❌            | ❌       |
...
📖 [完整安裝指南](https://E.Events/docs/getting-started?utm_source=gh-readme)

<br>

## E.Events 雲端版

不想自行託管？**[E.Events 雲端版](https://app.E.Events/auth/register?utm_source=gh-readme)** 是完全託管的選項，無需設定、自動更新及託管基礎設施。

[立即開始 →](https://app.E.Events/auth/register?utm_source=gh-readme)
...
| 資源   | 連結                                                                                            |
|:-----|:----------------------------------------------------------------------------------------------|
| 入門指南 | [E.Events/docs/getting-started](https://E.Events/docs/getting-started?utm_source=gh-readme) |
| 配置說明 | [E.Events/docs/configuration](https://E.Events/docs/configuration?utm_source=gh-readme)     |
| API 參考 | [E.Events/docs/api](https://E.Events/docs/api?utm_source=gh-readme)                         |
...
📖 [技術文檔](https://E.Events/docs?utm_source=gh-readme) · 📧 [hello@E.Events](mailto:hello@E.Events) ·
...
於[發佈頁面](https://github.com/HiEventsDev/E.Events/releases)查看最新功能及改進。

<br>

## 授權條款

E.Events 採用 **AGPL-3.0 附加條款** 授權。商業授權另行提供。[了解更多](https://E.Events/licensing)。

<br>

<div align="center">

**[官方網站](https://E.Events)** · **[技術文檔](https://E.Events/docs)** · **[Twitter/X](https://x.com/HiEventsTickets)**
